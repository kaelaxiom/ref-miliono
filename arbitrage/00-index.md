...
> Modelos donde explotas diferencias de precio o información entre mercados — sin producto propio.
...
| Modelo | Esfuerzo Inicial | Escalabilidad | Pasividad | Mejor para |
|--------|-----------------|---------------|-----------|------------|
